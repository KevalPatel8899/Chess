...
public class ChessLogic {
                ...
                if (chessPiece.contains("black")) {
                    if (x + 1 <= 7) {
                        ...
                        if (!enPassant.equals("") && x == 4) {
                            ...
                            if (Math.abs(enPassant_y - y) == 1)
                                locations.add("box" + (x + 1) + (enPassant_y));
                        }
                    }
                } else {
                    if (x - 1 >= 0) {
    ...
    public List<String> possibleMoves(String chessPiece, boolean virtualCall) {
        ...
        if (chessPiece.contains("king")) {
            if (WHITE_TURN) {
                if (WHITE_Q_SIDE_CASTLE_RIGHTS && !finalRet.contains("box73"))
                    finalRet.remove("box72");
                else if (WHITE_K_SIDE_CASTLE_RIGHTS && !finalRet.contains("box75"))
                    finalRet.remove("box76");
            } else {
                if (BLACK_Q_SIDE_CASTLE_RIGHTS && !finalRet.contains("box03"))
                    finalRet.remove("box02");
