...
public class ChessPiece {
  ...
  public List<String> chessMove() {
    ...
    String locationXS =
        chessPieceLocation.substring(
            chessPieceLocation.length() - 2, chessPieceLocation.length() - 1);
      ...
      case "knight":
        {
          ...
          if (locationX + 2 <= 7 && locationY - 1 >= 0)
            locations.add(
                "box" + Integer.toString(locationX + 2) + Integer.toString(locationY - 1));
          if (locationX + 1 <= 7 && locationY - 2 >= 0)
            locations.add(
                "box" + Integer.toString(locationX + 1) + Integer.toString(locationY - 2));
      ...
      case "bishop":
        {
          for (int i = 1; i <= 7; i++) {
            if (locationX + i <= 7 && locationY + i <= 7)
              locations.add(
                  "box" + Integer.toString(locationX + i) + Integer.toString(locationY + i));
      ...
      case "king":
        {
          ...
          if (locationX + 1 <= 7 && locationY + 1 <= 7)
            locations.add(
                "box" + Integer.toString(locationX + 1) + Integer.toString(locationY + 1));
      ...
      default:
        {
          ...
          //                    if(locationX + 1 <=7){
          //                        locations.add("box"+ String.valueOf(locationX + 1) +
          // Integer.toString( locationY));
          //                        move = "box"+ String.valueOf(locationX + 1) + Integer.toString(
          // locationY+1);
          //                        if(locationY+1 <=7) {
          ...
          //                    }
          //                    if(locationX == 1){
          //                        locations.add("box"+Integer.toString( locationX + 2)+
          // Integer.toString( locationY));
          //                    }
          //
          //                }
